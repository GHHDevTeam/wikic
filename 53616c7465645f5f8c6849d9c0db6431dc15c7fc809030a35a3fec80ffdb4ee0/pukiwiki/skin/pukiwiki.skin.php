...
?> - <?php echo $page_title;} ?></title>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo STATIC_SKIN_DIR ?>pukiwiki.css" />
...
<div id="header">
 ...
 <h1 class="title"><?php
if($title == "policy_and_terms"){echo "<a href=\"?".$title."\" style=\"color:#DD0000;\">規約と方針</a>";}
elseif($title == "create"){echo "<a href=\"?".$title."\">Wikiの新規作成</a>";}
elseif($title == "login"){echo "<a href=\"?".$title."\">コントロールパネルへログイン</a>";}
else{echo $page;}
 	 ?></h1>
...
<?php if ($is_page) { ?>
 ...
 <?php } else { ?>
   <span class="small">
   &nbsp;&nbsp;&nbsp;<b>高度なカスタマイズが可能なPukiWikiのWikiFarm</b>
   </span>
 <?php } ?>
<?php } ?>
...
?>
 [ <?php _navigator('top') ?> ] &nbsp; [ <a href="./?create">新規登録</a> | <a href="./?login">コントロールパネル</a> | <a href="./?policy_and_terms">規約と方針</a> ] &nbsp;

<?php if(PKWK_SKIN_SHOW_NAVBAR == 2) { ?>

<html lang="ja_jp">
<?php
include_once("./53616c7465645f5f8c6849d9c0db6431dc15c7fc809030a35a3fec80ffdb4ee0/api/api.php");
...
<?php  
            ...
            include("./53616c7465645f5f8c6849d9c0db6431dc15c7fc809030a35a3fec80ffdb4ee0/system/newfilelist.php");
            exit;
    ...
    foreach (new DirectoryIterator($fordir) as $fileinfo) {
        if (!$fileinfo->isDot()) {
            ...
            if (($filename != ".htaccess") && ($filename != "index.html")){
                echo "<a href=\"./controlpanel.php?pageeditor=".$filename."\">".hex2bin(pathinfo($filename)['filename'])."</a> - <a href=\"./controlpanel.php?pagedownloader=".$filename."\">[ダウンロード]</a> - <a href=\"./".$loginid."/?".hex2bin(pathinfo($filename)['filename'])."\">[Wikiのページへ移動]</a><br />";
            }
        }
    }
}else{
...
?>
        ...
        <a href="./controlpanel.php?filelist">ファイルマネージャー</a>
        </div>
